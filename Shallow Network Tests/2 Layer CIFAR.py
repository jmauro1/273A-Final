...
This file generates a six layer CNN with 2 linear layers in order to perform classification on the CIFAR10 dataset. The code compares results when the Network
contains batch normalization, weight normalization, batch and weight normalization, and no normalization.

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1EKbxHRMgb-3zudj3PXMPzKYngvVlOX2V
"""
...
class six_layer_convnet(nn.Module): #define network
    ...
    def __init__(self, weight_normalization = True):
        ...
        self.linear1_batchnorm = nn.BatchNorm1d(500)
...
plt.title("Error on CIFAR Training Data - 2 Layers")
#plt.caption("2 linear layers at end of CNN")
plt.savefig("CNN_2layerTrain.png")
files.download("CNN_2layerTrain.png")
plt.show()
...
plt.title("Error on CIFAR Test Data - 2 Layers")
#plt.caption("2 linear layers at end of CNN")
plt.savefig("CNN_2layerTest.png")
files.download("CNN_2layerTest.png")
plt.show()
