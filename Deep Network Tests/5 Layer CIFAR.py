...
Original file is located at
    https://colab.research.google.com/drive/1xllALASIFh5-Ku_aIo0mjmt-ZXzABhyW
"""
...
class nine_layer_convnet(nn.Module): #Define the network
...
net = nine_layer_convnet(weight_normalization = True)
net = net.to(device)
...
net = nine_layer_convnet(weight_normalization = False)
net = net.to(device)
...
plt.title("Error on CIFAR Training Data - 5 Layers")
plt.savefig("CNN_5layerTrain.png")
files.download("CNN_5layerTrain.png")
plt.show()
...
plt.title("Error on CIFAR Test Data - 5 Layers")
#plt.caption("2 linear layers at end of CNN")
plt.savefig("CNN_5layerTest.png")
files.download("CNN_5layerTest.png")
plt.show()
